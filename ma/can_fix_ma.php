              ...
              <table class="table align-items-center table-flush">
                <thead class="thead-light">
                  <tr>
                    ...
                    <th scope="col">ผู้รับงาน</th></th></th>
                  ...
                  <tr>
                    ...
                    <?php
                      ...
                      if($objResult['ac_name']==""){
                        ...
                        ?>                    
                      <td ><?php echo $objResult['ac_name']; ?></td>
                      <?php
                      }
                      ?>
                    ...
                    <td><a href="fullview_canfix_ma.php?case_id=<?php echo $objResult['case_id'];?>" class="btn btn-success">ดูรายละเอียดงาน</a></td>
                <?php
