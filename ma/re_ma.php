...
session_start();
error_reporting(0);
include ('function_sp.php');
$insertdata = new DB_CONS();
                ...
                <div class="pl-lg-4">
                  <div class="row">
                    <div class="col-lg-6">
                      ...
                      <input type="text" id="about" name="about" class="form-control" placeholder="อุปกรณ์ที่มีปัญหา">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-12">
                      <div class="form-group">
                        ...
                        <input type="textarea" id="address" name="address" class="form-control" placeholder="สถานที่">
                      </div>
                    </div>
