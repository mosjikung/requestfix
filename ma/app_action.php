...
$leader_app = '';
$result = $appmgr->approvemgr($username,$leader_app);
?>
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="fullview_re_action.php?per_id=<?php echo $objResult['per_id'];?>" class="btn btn-success">ดูรายละเอียดงาน</a></td>
                <?php
