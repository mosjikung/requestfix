 ...
 define('DB_NAME','leave');
  ...
  class DB_CON{
        ...
        public function updatefullview($notice,$can_fix,$item,$s_item,$case_id){
           "UPDATE fix_it SET notice = '$notice', can_fix = '$can_fix', item = '$item' where case_id = '$case_id'";
        ...
        public function mgrapp($case_id , $notice ,$item,$s_item,$mgr_app){
           "UPDATE fix_it SET notice = '$notice' ,item = '$item', s_item = '$s_item' ,mgr_app = '$mgr_app' where case_id = '$case_id'";
