<?php
$str = "แจ้งซ่อม ="."From : $username
แจ้งซ่อมเกี่ยวกับ : $about ฝ่าย : $section 
อาการ : $problem
สถานที่ : $address;
วันที่ยื่น : $crt_time";
$chOne = curl_init();
...
//ADD header array
$headers = array( 'Content-type: application/x-www-form-urlencoded', 'Authorization: Bearer WFlsVAMiuh5XMzcafFbocLEhmk3ATrI04Pxd5RhvrPP', );
