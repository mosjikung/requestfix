              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="fullview_end_work_ma.php?case_id=<?php echo $objResult3['case_id']; ?>"class="btn btn-success">ดูรายละเอียด</a></td>
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="fullview_end_work_ma.php?case_id=<?php echo $objResult4['case_id']; ?>"class="btn btn-success">ดูรายละเอียด</a></td>
