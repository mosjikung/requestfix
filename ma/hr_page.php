...
<head>
  ...
  <!-- Page plugins -->
  <!-- Argon CSS -->
  <link rel="stylesheet" href="assets/css/stable.css" type="text/css">
</head>
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="it_page.php?case_id=<?php echo $objResult['case_id']; ?>&update=1" onClick="return confirm('คุณต้องการรับงานนี้หรือไม่ ?');" class="btn btn-success">รับงาน</a></td>
