 ...
 define('DB_NAME','leave');
  ...
  class DB_CON{
        ...
        public function fetchonerecord($case_id) {
           "SELECT * FROM fix_ma WHERE case_id = '$case_id'";
            $result = mysqli_query($this->dbcon, "SELECT * FROM fix_ma WHERE case_id = '$case_id'");
            return $result;
        }

        public function showmgr($case_id,$can_fix,$fix_stat) {
                  "SELECT * FROM fix_ma where can_fix !='$can_fix' and fix_stat = '$fix_stat' and $case_id = '$case_id'";
        ...
        public function canfixit($username,$fix_stat){
            "SELECT * FROM fix_ma where ac_name = '$username' and fix_stat = '$fix_stat'";
        ...
        public function updatefullview($notice,$can_fix,$item,$s_item,$case_id){
          "UPDATE fix_ma SET notice = '$notice', can_fix = '$can_fix', item = '$item' , s_item =  '$s_item' where case_id = '$case_id'";
        ...
        public function finish($case_id,$fix_stat,$end_date,$end_time){
           "UPDATE fix_ma SET fix_stat = '$fix_stat' , end_time = '$end_time', end_date = '$end_date' where case_id = '$case_id'";
        ...
        public function mgrapp($case_id , $notice ,$item,$s_item,$mgr_app){
           "UPDATE fix_ma SET notice = '$notice' ,item = '$item', s_item = '$s_item' ,mgr_app = '$mgr_app' where case_id = '$case_id'";
      ...
      public function update_last($case_id,$notice,$user_app){
        "UPDATE fix_ma SET notice = '$notice',user_app = '$user_app' where case_id = '$case_id'";
      ...
      public function last_check($fix_stat,$user_app,$ac_name){
         "SELECT * FROM fix_ma where fix_stat = '$fix_stat' and user_app  != '$user_app' and ac_name = '$ac_name' ";
      ...
      public function insert_suggestion($username,$company,$section,$q1,$q2,$q3,$q4,$q5,$sugguestion,$case_id,$crt_date){
        ...
        "INSERT INTO question_ma (username,company,section,q1,q2,q3,q4,q5,sugguestion,case_id,crt_date) value ('$username','$company'
      ...
      public function nottification_mgr($fix_stat,$mgr_app){
         "SELECT * FROM fix_ma where fix_stat != '$fix_stat' and mgr_app = '$mgr_app'";
      ...
      public function nottification_hr($fix_stat,$ac_name){
        "SELECT * FROM fix_ma where fixstat = '$fix_stat' and ac_name = '$ac_name'";
