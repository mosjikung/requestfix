...
if (isset($_POST['insert'])) {
      ...
      $sql = $insertdata->add_spare($part_name,$kind_part,$crt_date,$status,$detail,$serial_number,$username);
      
      if($sql) {
      
      
      echo "<script>alert('บันทึกสำเร็จ!');</script>";
      echo "<script>window.location.href='../it/add_part.php'</script>";
    }else{
              ...
              <form name='form1' method="post">
                ...
                <div class="pl-lg-4">
                  <div class="row">
                    ...
                    <input type="text" class="form-control" name="part_name" id="part_name"  placeholder="ชื่ออุปกรณ์">
                    </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="kind_part" id="kind_part" placeholder="ประเภทอุปกรณ์">
                      </div>
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="textarea" id="detail" name="detail" class="form-control" placeholder="รายละเอียด">
                      </div>
                    </div>
                    <div class="col-lg-6">
                    <div class="form-group">
