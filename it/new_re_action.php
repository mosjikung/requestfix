...
if(isset($_POST['insert'])){
  ...
  $result = $insert_data->insertaction2($action,$name,$surname,$account_id,$password,$email,$emailex,$file1,$per_r1,
...
<body> 
<?php
  include_once ('main_new_user.php');
  include_once ('top_new_user.php');
            ...
            <div class="card-body">
              <form name='form1' method="post">
                ...
                <form name = "form1" method = "post">
                  ...
                  <div class="form-group">
                    <label class="form-control-label">ผู้บังคับบัญชา</label>
                    <input type="text" id="leader1" name="leader1" class="form-control" placeholder="ผู้บังคับบัญชา">
                  </div>
                  </div>
