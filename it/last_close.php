...
$lastshow = new DB_CON();
  ...
  $result = $lastshow->last_check($fix_stat,$user_app,$ac_name);
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td >  <?php echo $objResult['username']; ?></td>
                      ...
                      <td ><?php echo $objResult['user_app']; ?></td>



                    <td><a href="it_page.php?case_id=<?php echo $objResult['case_id']; ?>&update=1" class="btn btn-success">ดูรายละเอียด</a></td>
