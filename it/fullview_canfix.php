...
if(isset($_POST['update'])){
      ...
      if($can_fix==""){
        ...
        echo "<script>window.location.href='fullview_canfix.php?case_id=$case_id'</script>";
      }else{
        echo "<script>alert('บันทึกสำเร็จ')</script>";
        echo "<script>window.location.href='can_fix.php'</script>";
$result4 = $updatefix->updatefullview($notice,$can_fix,$item,$s_item,$last_update,$who_update,$case_id);
