...
<head>
  ...
  <title>Nutrition Request Fix</title>
  <!-- Favicon -->
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-center" >  <?php echo $objResult['username']; ?></td>
                      ...
                      <td class="text-center"><?php echo $objResult['action']; ?></td>


                      <td class="text-center"><?php echo $objResult['strdate']; ?></td>

                     



                    <td class="text-center" ><a href="fullview_re_action.php?per_id=<?php echo $objResult['per_id'];?>" class="btn btn-success">ดูรายละเอียดงาน</a></td>
                <?php
