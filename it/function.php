<?php
 ...
 define('DB_NAME','leave');
  ...
  class DB_CON{
        ...
        public function mgrapp($case_id , $notice ,$item,$s_item,$mgr_app,$last_update,$who_update){
          echo "UPDATE fix_it SET notice = '$notice' ,mgr_app = '$mgr_app',last_update = '$last_update',who_update = '$who_update' where case_id = '$case_id'";
          $mgr_app = mysqli_query($this->dbcon,"UPDATE fix_it SET notice = '$notice' ,mgr_app = '$mgr_app',last_update = '$last_update',who_update = '$who_update' where case_id = '$case_id'");
          return $mgr_app;
       }
