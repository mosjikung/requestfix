...
$showall_q = new DB_CONZ();
$result = $showall_q->showallreport();
?>
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <?php
                    if($objResult['case_id']!==""){
                    ?>
                      <td ><?php echo "case id :". $objResult['case_id']; ?></td>
                      <?php
                  }else{
                      ?>
                      <td ><?php echo "permission id:".$objResult['per_id']; ?></td>
                      <?php
                  }
                      ?>
                    <td ><?php echo $objResult['summary_score']; ?></td>



                    <td><a href="fullview_report_question.php?q_id=<?php echo $objResult['q_id']; ?>"  class="btn btn-success">รายละเอียดงาน</a></td>
