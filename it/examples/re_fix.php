...
if (isset($_POST['insert'])) {
    ...
    $sql = $insertdata->insertfixit($username, $section, $about, $problem, $number,$notice,$crt_time,$crt_date);
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                          <select class="form-control" name="about" id="about">
                              ...
                              <option value="อุปกรณ์เครื่องคอมพิวเตอร์">อุปกรณ์เครื่องคอมพิวเตอร์</option>
                              <option value="ปริ้นเตอร์">ปริ้นเตอร์</option>
                              <option value="อุปกรณ์เครือข่าย">อุปกรณ์เครือข่าย</option>
                              <option value="เกี่ยวกับโปรแกรม">เกี่ยวกับโปรแกรม</option>
