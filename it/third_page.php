        ...
        ?>
          ...
          <div class="container">
            <h1>เลือกหัวข้อใช้บริการ</h1>
                ...
                <form method="get" action="re_fix.php">
                <button type="submit" name="computer" id="computer" value="ใบแจ้งซ่อม">ใบแจ้งซ่อม</button>
                </form> <form method="get" action="user_page.php">
        ...
        ?>
          ...
          <div class="container">
            ...
            <form method="get" action="re_action.php">
                ...
                <form method="get" action="re_fix.php">
                <button type="submit" name="computer" id="computer" value="ใบแจ้งซ่อม">ใบแจ้งซ่อม</button>
                </form> <form method="get" action="leader_page.php">
                <button type="submit" name="user" id="user">Main page</button>
                </form>
        ...
        ?>
          ...
          <div class="container">
            ...
            <form method="get" action="re_action.php">
                ...
                <form method="get" action="hr_page.php">
                <button type="submit" name="user" id="user">Main Page</button>
                </form>
          ...
          <div class="container">
            <h1>เลือกหัวข้อใช้บริการ</h1>
               ...
               <form method="get" action="re_action.php">
                ...
                <form method="get" action="re_fix.php">
                <button type="submit" name="computer" id="computer" value="ใบแจ้งซ่อม">ใบแจ้งซ่อม</button>
                </form> <form method="get" action="mgr_page.php">
                <button type="submit" name="user" id="user">Main Page</button>
                </form>
